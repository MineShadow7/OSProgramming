 ...
 *
 * <описание>
 *   Данный заголовок описывает интерфейс IEcoVideoCoreIV1V3DRegisters
 * </описание>
 *
 * <ссылка>
 *
...
#ifndef __I_ECO_VIDEO_CORE_IV_1_V3D_REGISTERS_H__
#define __I_ECO_VIDEO_CORE_IV_1_V3D_REGISTERS_H__
...
#define V3D_IDENT2 0x008 // V3D Identification 1 (V3D Configuration B)
...
#define V3D_CT0CS                                                              \
  (0x100 >> 2) // Control List Executor Thread 0 Control and Status.
#define V3D_CT1CS                                                              \
  (0x104 >> 2) // Control List Executor Thread 1 Control and Status.
...
#define V3D_CT0CA                                                              \
  (0x110 >> 2) // Control List Executor Thread 0 Current Address.
#define V3D_CT1CA                                                              \
  (0x114 >> 2) // Control List Executor Thread 1 Current Address.
#define V3D_CT00RA0                                                            \
  (0x118 >> 2) // Control List Executor Thread 0 Return Address.
#define V3D_CT01RA0                                                            \
  (0x11c >> 2)                 // Control List Executor Thread 1 Return Address.
...
#define V3D_CT0PC                                                              \
  (0x128 >> 2) // Control List Executor Thread 0 Primitive List Counter
#define V3D_CT1PC                                                              \
  (0x12c >> 2) // Control List Executor Thread 1 Primitive List Counter
...
#define V3D_FDBGB                                                              \
  (0xf08 >> 2) // FEP Interface Ready and Stall Signals, FEP Busy Signals
#define V3D_FDBGR (0xf0c >> 2) // FEP Internal Ready Signals
#define V3D_FDBGS (0xf10 >> 2) // FEP Internal Stall Input Signals

#define V3D_ERRSTAT                                                            \
  (0xf20 >> 2) // Miscellaneous Error Signals (VPM, VDW, VCD, VCM, L2C)

typedef struct ECO_V3D_REGISTER_MAP {
    uint32_t AddressOffset;            /* Address offset: 0x00 */
} ECO_V3D_REGISTER_MAP;

typedef struct ECO_V3D_CONFIG_DESCRIPTOR {
    union {
        uint32_t BaseAddress;
        struct ECO_V3D_REGISTER_MAP* Map;
    } Register;
} ECO_V3D_CONFIG_DESCRIPTOR;

/* IEcoVideoCoreIV1V3DRegisters IID = {C0E5C5AC-0080-4E7C-9D3A-CD2BAAC4BA16} */
#ifndef __IID_IEcoVideoCoreIV1V3DRegisters
static const UGUID IID_IEcoVideoCoreIV1V3DRegisters = {0x01, 0x10, 0xC0, 0xE5, 0xC5, 0xAC, 0x00, 0x80, 0x4E, 0x7C, 0x9D, 0x3A, 0xCD, 0x2B, 0xAA, 0xC4, 0xBA, 0x16};
#endif /* __IID_IEcoVideoCoreIV1V3DRegisters */

typedef struct IEcoVideoCoreIV1V3DRegistersVTbl {

    /* IEcoUnknown */
    int16_t (*QueryInterface)(/* in */ struct IEcoVideoCoreIV1V3DRegisters* me, /* in */ const UGUID* riid, /* out */ void **ppv);
    uint32_t (*AddRef)(/* in */ struct IEcoVideoCoreIV1V3DRegisters* me);
    uint32_t (*Release)(/* in */ struct IEcoVideoCoreIV1V3DRegisters* me);

    /* IEcoVideoCoreIV1V3DRegisters */
    int16_t (*set_ConfigDescriptor)(/* in */ struct IEcoVideoCoreIV1V3DRegisters* me, /* in */ ECO_V3D_CONFIG_DESCRIPTOR* config);
    ECO_V3D_CONFIG_DESCRIPTOR* (*get_ConfigDescriptor)(/* in */ struct IEcoVideoCoreIV1V3DRegisters* me);

} IEcoVideoCoreIV1V3DRegistersVTbl, *IEcoVideoCoreIV1V3DRegistersVTblPtr;

interface IEcoVideoCoreIV1V3DRegisters {
    struct IEcoVideoCoreIV1V3DRegistersVTbl *pVTbl;
} IEcoVideoCoreIV1V3DRegisters;

#endif /* __I_ECO_VIDEO_CORE_IV_1_V3D_REGISTERS_H__ */
