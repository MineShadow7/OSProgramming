...
typedef struct IEcoToolchainLexicalAnalyzer1TokenVTbl {
    ...
    char_t* (ECOCALLMETHOD *get_Lexeme)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me);
    void (ECOCALLMETHOD *set_Tag)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me, /* in */ char_t* tag); // пользовательские параметры, например для расскарашивания текста 
    char_t* (ECOCALLMETHOD *get_Tag)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me);
    char_t* (ECOCALLMETHOD *get_Description)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me);// описание, из правил
    uint32_t (ECOCALLMETHOD *get_Line)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me);// инфо о строке 
    uint32_t (ECOCALLMETHOD *get_Column)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me);// о колонке
    ...
    uint16_t (ECOCALLMETHOD *get_Length)(/* in */ IEcoToolchainLexicalAnalyzer1TokenPtr_t me);
